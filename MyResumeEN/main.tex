% use pdflatex -> bibtex -> pdflatex * 2 to compile
...
\usepackage{xcolor}
% 自定义颜色
\definecolor{darkred}{RGB}{139,0,0}  % 定义深红色
% 重新定义带有红色标题和水平线的 section
% \newcommand{\mysection}[1]{
%   \section*{\textcolor{darkred}{#1}}  % 设置标题为深红色
%   \vspace{-1.8em}  % 调整标题与水平线的距离
%   \rule{\textwidth}{0.4pt}  % 生成整行宽的水平线
%   \vspace{-1.2em}  % 调整水平线与内容的距离
% }
...
% Add equal contribution dagger and google scholar
\newcommand*{\scholarsocialsymbol}{\includegraphics[height=.6\baselineskip]{google-scholar}}
