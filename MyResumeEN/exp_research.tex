...
{\small
$*$ Led a PLM-based deep reinforcement learning project for the miniaturization of biomedically important proteins under delivery constraints, with experimental validation.\\
$*$ Developed mining methods to identify novel type VI CRISPR systems.\\
...
$*$ \textbf{Ph.D. thesis:} \textit{``Safety Evaluation and Miniaturization Algorithm Design for Gene Editing Tools''.}
}
